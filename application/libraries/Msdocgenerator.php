...
class Msdocgenerator
{
     ...
     * 
     * @param $pageOrientation: The
     *            orientation of the pages of the initial session, 'PORTRAIT' or 'LANDSCAPE'
     * @param $pageType: The
     *            initial type of the paper of the pages of the session
     * @param $cssFile: extra
     *            file with formating configurations, in css file format
     * @param $topMargin: top
 ...
 // end clsMsDocGenerator()
     ...
     * 
     * @param $pageOrientation: The
     *            orientation of the pages of the this session, 'PORTRAIT' or 'LANDSCAPE'
     * @param $pageType: The
     *            type of the paper of the pages of the this session
     * @param $topMargin: top
     *            margin of the this session
     * @param $rightMargin: right
     *            margin of the this session
     * @param $bottomMargin: bottom
     *            margin of the this session
 ...
 // end newPage()
     ...
     * @param $saveInPath: if
     *            not empty will be the path to save document otherwise show
     */
 ...
 // end setFontSize()
     ...
     *            of the paragraph
     * @param $inlineStyle: array
     *            of css block properties
 ...
 // end addImage()
     ...
     * 
     * @param $inlineStyle: array
     *            of css table properties, property => value
     * @param $className: class
     *            name of any class defined, may be in extra format file
     */
 ...
 // end startTable()
     ...
     * 
     * @param $cells: array
     *            with content of cells of the row
     * @param $aligns: array
     *            with align cell constants in html style, a item for each cell item
     * @param $vAligns: array
     *            with vertical align cell constants in html style, a item for each cell item
     * @param $inlineStyle: array
     *            of css block properties, property => value
     * @param $classesName: array
     *            with class name of any class defined in extra format file, a item for each cell item
     */
