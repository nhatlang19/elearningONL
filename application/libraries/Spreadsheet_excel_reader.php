...
require_once '../upgrade/application/libraries/Oleread.inc';
// require_once APPLICATION_PATH . '/../library/oleread.inc';
            ...
            switch ($code) {
                case SPREADSHEET_EXCEL_READER_TYPE_SST:
                    ...
                    for ($i = 0; $i < $uniqueStrings; $i ++) {
                        ...
                        // luan fixed
                        $text = mb_convert_encoding($retstr, 'UTF-8');
                        $text = html_entity_decode($text, ENT_QUOTES, "UTF-8");
                        
                        $retstr = ($asciiEncoding) ? $text : $this->_encodeUTF16($retstr);
