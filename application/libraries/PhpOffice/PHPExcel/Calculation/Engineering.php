...
class PHPExcel_Calculation_Engineering
{
     ...
     *            number
     * @return string[] on "real", "imaginary" and "suffix"
     */
 ...
 // function _parseComplex()
     ...
     * @param string $complexNumber
     *            number to clean
     * @return string "cleaned" complex number
     */
     ...
     *            that we want to pad this value
 ...
 // function BESSELI()
     ...
     * @param integer $ord
     *            of the Bessel function. If n is not an integer, it is truncated.
 ...
 // function BESSELY()
     ...
     * @category Engineering Functions
     * @param string $x
     *            number (as a string) that you want to convert. The number
 ...
 // function BINTODEC()
     ...
     * @param integer $places
     *            of characters to use. If places is omitted, BIN2HEX uses the
 ...
 // function BINTOHEX()
     ...
     * @param integer $places
     *            of characters to use. If places is omitted, BIN2OCT uses the
     *            minimum number of characters necessary. Places is useful for padding the
     *            return value with leading 0s (zeros).
     *            If places is not an integer, it is truncated.
 ...
 // function BINTOOCT()
     ...
     * @category Engineering Functions
     * @param string $x
     *            integer you want to convert. If number is negative,
     ...
     *            error value.
     * @param integer $places
     *            of characters to use. If places is omitted, DEC2BIN uses
 ...
 // function DECTOBIN()
     ...
     *            #NUM! error value.
     * @param integer $places
     *            of characters to use. If places is omitted, DEC2HEX uses
     *            the minimum number of characters necessary. Places is useful for
     *            padding the return value with leading 0s (zeros).
     *            If places is not an integer, it is truncated.
 ...
 // function DECTOHEX()
     ...
     *            #NUM! error value.
     * @param integer $places
     *            of characters to use. If places is omitted, DEC2OCT uses
     *            the minimum number of characters necessary. Places is useful for
     *            padding the return value with leading 0s (zeros).
     *            If places is not an integer, it is truncated.
 ...
 // function DECTOOCT()
     ...
     *            the #NUM! error value.
     * @param integer $places
     *            of characters to use. If places is omitted,
 ...
 // function HEXTOBIN()
     ...
     * @category Engineering Functions
     * @param string $x
     *            number you want to convert. This number cannot
 ...
 // function HEXTODEC()
     ...
     *            the #NUM! error value.
     * @param integer $places
     *            of characters to use. If places is omitted, HEX2OCT
 ...
 // function HEXTOOCT()
     ...
     * @category Engineering Functions
     * @param string $x
     *            number you want to convert. Number may not
 ...
 // function OCTTOBIN()
     ...
     * @category Engineering Functions
     * @param string $x
     *            number you want to convert. Number may not contain
 ...
 // function OCTTODEC()
     ...
     *            the #NUM! error value.
     * @param integer $places
     *            of characters to use. If places is omitted, OCT2HEX
 ...
 // function OCTTOHEX()
     ...
     *            coefficient of the complex number.
     * @param float $imaginary
     *            coefficient of the complex number.
     * @param string $suffix
     *            for the imaginary component of the complex number.
 ...
 // function COMPLEX()
     ...
     * @category Engineering Functions
     * @param string $complexNumber
     *            number for which you want the imaginary
     *            coefficient.
     * @return float
     */
 ...
 // function IMAGINARY()
     ...
     * @category Engineering Functions
     * @param string $complexNumber
     *            number for which you want the real coefficient.
     * @return float
     */
 ...
 // function IMABS()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the argument theta.
     * @return float
     */
 ...
 // function IMARGUMENT()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the conjugate.
     * @return string
     */
 ...
 // function IMCONJUGATE()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the cosine.
     * @return string|float
     */
 ...
 // function IMCOS()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the sine.
     * @return string|float
     */
 ...
 // function IMSQRT()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the natural logarithm.
     * @return string
     */
 ...
 // function IMLN()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the common logarithm.
     * @return string
     */
 ...
 // function IMLOG10()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the base-2 logarithm.
     * @return string
     */
 ...
 // function IMLOG2()
     ...
     *
     * @param string $complexNumber
     *            number for which you want the exponential.
     * @return string
     */
 ...
 // function IMEXP()
     ...
     *
     * @param string $complexNumber
     *            number you want to raise to a power.
     * @param float $realNumber
     *            to which you want to raise the complex number.
     * @return string
     */
 ...
 // function IMDIV()
     ...
     *            number from which to subtract complexNumber2.
     * @param string $complexNumber2
     *            number to subtract from complexNumber1.
     * @return string
     */
 ...
 // function IMPRODUCT()
     ...
     *            number.
     * @param float $b
     *            number. If omitted, b is assumed to be zero.
     * @return int
     */
 ...
 // function getConversionGroups()
     ...
     *
     * @param string $group
     *            whose units of measure you want to retrieve
     * @return array
     */
