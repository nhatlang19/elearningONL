...
class PHPExcel_Calculation_Financial
{
 ...
 // function EFFECT()
     ...
     * @param float $pmt
     *            made each period: it cannot change over the
     *            life of the annuity. Typically, pmt contains principal
     *            and interest but no other fees or taxes.
     * @param float $pv
     *            or the lump-sum amount that a series of
 ...
 // function IPMT()
     ...
     *
     * @param float[] $values
     *            or a reference to cells that contain numbers for which you want
     *            to calculate the internal rate of return.
     *            Values must contain at least one positive value and one negative value to
     *            calculate the internal rate of return.
     * @param float $guess
     *            that you guess is close to the result of IRR
     * @return float
     */
 ...
 // function ISPMT()
     ...
     *
     * @param float[] $values
     *            or a reference to cells that contain a series of payments and
     *            income occurring at regular intervals.
     *            Payments are negative value, income is positive values.
     * @param float $finance_rate
     *            rate you pay on the money used in the cash flows
     * @param float $reinvestment_rate
     *            rate you receive on the cash flows as you reinvest them
     * @return float
     */
