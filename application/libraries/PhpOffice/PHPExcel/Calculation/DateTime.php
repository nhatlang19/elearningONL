...
class PHPExcel_Calculation_DateTime
{
     ...
     * @param integer $year
     *            to test
     * @return boolean if the year is a leap year, otherwise FALSE
     */
 ...
 // function _isLeapYear()
     ...
     *            to use the US method or the European method of calculation
 ...
 // function DATENOW()
     ...
     * @category Date/Time Functions
     * @param integer $year
     *            of the year argument can include one to four digits.
     ...
     *            #NUM! error value.
     * @param integer $month
     *            or negative integer representing the month of the year
     ...
     * @param integer $day
     *            or negative integer representing the day of the month
     *            from 1 to 31.
 ...
 // function DATE()
     ...
     * @category Date/Time Functions
     * @param integer $hour
     *            from 0 (zero) to 32767 representing the hour.
     *            Any value greater than 23 will be divided by 24 and the remainder
     *            will be treated as the hour value. For example, TIME(27,0,0) =
     *            TIME(3,0,0) = .125 or 3:00 AM.
     * @param integer $minute
     *            from 0 to 32767 representing the minute.
     *            Any value greater than 59 will be converted to hours and minutes.
     *            For example, TIME(0,750,0) = TIME(12,30,0) = .520833 or 12:30 PM.
     * @param integer $second
     *            from 0 to 32767 representing the second.
 ...
 // function DATEVALUE()
     ...
     * @category Date/Time Functions
     * @param string $timeValue
     *            string that represents a time in any one of the Microsoft
 ...
 // function TIMEVALUE()
     ...
     *            serial value, PHP date/time stamp, PHP DateTime object
     *            or a standard date string
     * @param mixed $endDate
     *            serial value, PHP date/time stamp, PHP DateTime object
     *            or a standard date string
     * @param string $unit            
     * @return integer between the dates
     */
 ...
 // function DATEDIF()
     ...
     * @category Date/Time Functions
     * @param mixed $startDate
     *            serial value (float), PHP date timestamp (integer),
     ...
     *            same month.
     * @return integer of days between start date and end date
     */
 ...
 // function YEARFRAC()
     ...
     *            of Excel date serial value (float), PHP date
 ...
 // function NETWORKDAYS()
     ...
     *            of nonweekend and nonholiday days before or after
 ...
 // function DAYOFMONTH()
     ...
     *            PHP DateTime object, or a standard date string
     * @param int $style
     *            that determines the type of return value
     *            1 or omitted Numbers 1 (Sunday) through 7 (Saturday).
     *            2 Numbers 1 (Monday) through 7 (Sunday).
     *            3 Numbers 0 (Monday) through 6 (Sunday).
     * @return int of the week value
     */
 ...
 // function SECONDOFMINUTE()
     ...
     *            of months before or after start_date.
