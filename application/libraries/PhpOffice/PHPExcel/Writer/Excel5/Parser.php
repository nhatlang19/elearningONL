...
class PHPExcel_Writer_Excel5_Parser
{
     ...
     *            code for conversion to its ptg value
     * @return string error code ptgErr
     */
     ...
     * @return string reference index in packed() format
     */
     ...
     * @return integer sheet index, -1 if the sheet was not found
     */
