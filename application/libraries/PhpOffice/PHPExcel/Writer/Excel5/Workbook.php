...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
     ...
     * @param mixed $parser
     *            parser created for the Workbook
     */
     ...
     *            in bytes of the binary worksheet streams
     * @return string data for workbook stream
     */
...
$rowmin, $rowmax, $colmin, $colmax);
     ...
     * @param string $name            
     * @param string $sheetIndex
     *            sheet index the defined name applies to. 0 = global
