...
class PHPExcel_Shared_TimeZone
{
 ...
 // function getTimezone()
     ...
     *            timezone for finding the transitions
     * @param integer $timestamp
     *            date/time value for finding the current transition
     * @return array current transition details
     */
     ...
     *
     * @param string $timezone
     *            timezone for finding the adjustment to UST
     * @param integer $timestamp
     *            date/time value
     * @return integer of seconds for timezone adjustment
