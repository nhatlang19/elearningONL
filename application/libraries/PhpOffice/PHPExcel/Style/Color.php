...
class PHPExcel_Style_Color extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
     ...
     *            if this is a supervisor or not
     *            Leave this value at default unless you understand exactly what
     *            its ramifications are
     * @param boolean $isConditional
     *            if this is a conditional style or not
     *            Leave this value at default unless you understand exactly what
     *            its ramifications are
     */
     ...
     * @param int $offset
     *            the RGB value to extract
     * @param boolean $hex
     *            whether the component should be returned as a hex or a
     *            decimal value
     * @return string extracted colour component
     */
     ...
     *            whether the component should be returned as a hex or a
     *            decimal value
     * @return string red colour component
     */
     ...
     *            whether the component should be returned as a hex or a
     *            decimal value
     * @return string green colour component
     */
     ...
     *            whether the component should be returned as a hex or a
     *            decimal value
     * @return string blue colour component
     */
     ...
     *
     * @param string $hex
     *            as an RGBA or RGB value (e.g. FF00CCCC or CCDDEE)
     * @param float $adjustPercentage
     *            by which to adjust the colour as a float from -1 to 1
     * @return string adjusted colour as an RGBA or RGB value (e.g. FF00CCCC or CCDDEE)
     */
