...
class PHPExcel_Worksheet_AutoFilter
{
     ...
     *            (e.g. A)
     * @throws PHPExcel_Exception
     * @return integer column offset within the autofilter range
     */
     ...
     *            (e.g. A)
     * @throws PHPExcel_Exception
     * @return integer offset of the specified column within the autofilter range
     */
     ...
     *            simple string containing a Column ID like 'A' is permitted
     * @throws PHPExcel_Exception
     * @return PHPExcel_Worksheet_AutoFilter
     */
