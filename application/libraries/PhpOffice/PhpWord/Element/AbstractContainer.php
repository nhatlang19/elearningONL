...
abstract class AbstractContainer extends AbstractElement
{
    ...
    protected function addElement($elementName)
    {
        ...
        // Get arguments
        $args = func_get_args();
        $withoutP = in_array($this->container, array(
            'TextRun',
            'Footnote',
            'Endnote',
            'ListItemRun',
    ...
    private function setElementRelationId(AbstractElement $element, $elementName, $source)
    {
        ...
        $hasMediaRelation = in_array($elementName, array(
            'Link',
            'Image',
            'Object'
        ));
        $hasOtherRelation = in_array($elementName, array(
            'Footnote',
            'Endnote',
            'Title'
        ));
