...
class DocumentProperties
{
    ...
    {
        $typeGroups = array(
            self::PROPERTY_TYPE_INTEGER => array(
                'i1',
                'i2',
                'i4',
                'i8',
            ...
            self::PROPERTY_TYPE_FLOAT => array(
                'r4',
                'r8',
                'decimal'
            ),
            self::PROPERTY_TYPE_STRING => array(
                'empty',
                'null',
                'lpstr',
                'lpwstr',
            ...
            self::PROPERTY_TYPE_DATE => array(
                'date',
                'filetime'
            ),
            self::PROPERTY_TYPE_BOOLEAN => array(
                'bool'
            )
        );
