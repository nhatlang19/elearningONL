<div id="dialog" class="modal-block mfp-hide">
	<section class="panel">
		<header class="panel-heading">
			<h2 class="panel-title">Bạn có chắc chắn?</h2>
		</header>
		<div class="panel-body">
			<div class="modal-wrapper">
				<div class="modal-text">
					<p>Bạn có chắc chắn muốn xoá dòng này?</p>
				</div>
			</div>
		</div>
		<footer class="panel-footer">
			<div class="row">
				<div class="col-md-12 text-right">
					...
					<button id="dialogCancel" class="btn btn-default">Huỷ</button>
				</div>
			</div>
		</footer>
	</section>
	...
	<section class="panel">
		...
		<div class="panel-body">
			<div class="modal-wrapper">
				...
				<div class="modal-text">
					<h4>Cảnh báo</h4>
					<p>Không thể xoá kho câu hỏi này</p>
				</div>
			</div>
		</div>
		<footer class="panel-footer">
