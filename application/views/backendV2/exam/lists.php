...
<section class="panel">
	<header class="panel-heading">
		...
		<h2 class="panel-title">Danh sách hình thức thi</h2>
	</header>
	<div class="panel-body">
		...
		<table class="table table-bordered table-striped mb-none" id="datatable-editable">
			...
			<tbody>
                ...
                ?>
				<tr class="gradeX" data-id="<?php echo $value->exam_id; ?>">
					<td><?php echo $i++; ?></td>
                    ...
                    ?>
    					<div class="switch switch-sm switch-primary">
    						<input type="checkbox" name="switch" data-plugin-ios-switch <?php echo $checked; ?> data-id="<?php echo $value->exam_id; ?>" data-status="<?php echo $status; ?>"  />
    					</div>
					</td>
...
<script src="<?php echo BACKEND_V2_JS_PATH; ?>exam/datatables.editable.js"></script>
