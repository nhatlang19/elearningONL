...
<div class="row">
	<div class="col-lg-12">
		<?php echo form_open(BACKEND_V2_TMPL_PATH . 'block/edit', ['id' => 'form', 'class' => 'form-horizontal form-bordered', 'autocomplete' => 'off']); ?>
		<section class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-md-3 control-label" for="inputDefault">Tên khồi <span
						class="required">*</span>
					</label>
					<div class="col-md-6">
						<input name="title" maxlength="255" type="text" class="form-control"
							id="inputDefault" required
							value="<?php echo isset($block->title) ? $block->title : ''; ?>">
					</div>
				</div>
			</div>
...
<!-- Validate form -->
<script src="<?php echo BACKEND_V2_JS_PATH; ?>block/validation.js"></script>