...
<div class="row">
	<div class="col-lg-12">
		<?php echo form_open(BACKEND_V2_TMPL_PATH . 'subject/edit', ['id' => 'form', 'class' => 'form-horizontal form-bordered', 'autocomplete' => 'off']); ?>
		<section class="panel">
...
<!-- Validate form -->
<script src="<?php echo BACKEND_V2_JS_PATH; ?>subjects/validation.js"></script>