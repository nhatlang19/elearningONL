...
<head>
	...
	<link href="<?php echo CSS_PATH; ?>master.css" media="screen" rel="stylesheet" type="text/css">
	<link rel="stylesheet" href="<?php echo CSS_PATH; ?>bootstrap.css">
	<link rel="stylesheet" href="<?php echo CSS_PATH; ?>bootswatch.min.css">
	<link href="<?php echo CSS_PATH; ?>slickQuiz.css" media="screen" rel="stylesheet" type="text/css">
	
	<link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH; ?>fancybox2/jquery.fancybox.css?v=2.1.5" media="screen" />
	<link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH; ?>fancybox2/jquery.fancybox-buttons.css?v=1.0.5" />
	<link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH; ?>fancybox2/jquery.fancybox-thumbs.css?v=1.0.7" />
