					...
					<fieldset>
						...
						<p>
							...
							<select name="storage" id="storage"
								...
								?>
								<option <?php echo $selected; ?> value="<?php echo $item['storage_id']; ?>"><?php echo $item['title']; ?></option>
								<?php endforeach; ?>
							</select>
						</p>
						<p>
							<label id="questionId">Câu hỏi
							<span id="errorMsgQues" class="input-notification error png_bg red bold" style="display: none;">
							</span>
							</label>
							<?php
							...
							echo $this->ckeditor->editor("question_name", $text , $config_ckeditor);?> 							 
								<span class="input-notification png_bg" style="display: none;" >Successful message</span>
						...
						<p>
							...
							<select name="type" id="type"
								...
								<option value="0" <?php echo (!@$storage_questions['type'])?'selected="selected"':''?>>Text</option>
								<option value="1" <?php echo (@$storage_questions['type'])?'selected="selected"':''?>>Image</option>
								
							</select>
						</p>
						<label id="answer_sentence">Câu trả lời
							<span id="errorMsgAns" class="input-notification error png_bg red bold" style="display: none;">
							</span>
						</label>
						
						<span class="text" <?php echo (@$storage_questions['type'])?'style="display: none;"':''?>>
							...
							b. <input
								...
								<input type="checkbox" name="correct_answer" class="checkbox-answer"
						...
						<span class="image" <?php echo (!isset($storage_questions['type']) || !$storage_questions['type'])?'style="display: none;"':''?>>

							<p>
							a.  <input id="xImagePath0" class="text-input medium-input" name="ImagePath[]" 
								type="text" size="60" 
								value="<?php if(isset($storage_answer[0]['answer'])) echo $storage_answer[0]['answer']; ?>" />
								<input class="button" type="button" value="Browse Server" onclick="BrowseServer( 'Images:/', 'xImagePath0' );" />
								<input type="checkbox" name="checkbox1" class="checkbox-answer-img" 
								<?php if(isset($storage_answer[0]['correct_answer']) && $storage_answer[0]['correct_answer'] == 1) echo 'checked="checked"'; ?>
								value="0" /> 
								<?php if(isset($storage_answer[0]['answer'])) :?>
								<div>
									<img class="thumb" src="<?php echo $storage_answer[0]['answer']; ?>" width="100" />
								</div>
								<?php endif; ?>
								
							</p>
							<p>
							b.  <input id="xImagePath1" class="text-input medium-input" name="ImagePath[]" type="text" size="60"
								value="<?php if(isset($storage_answer[1]['answer'])) echo $storage_answer[1]['answer']; ?>" />
								<input class="button" type="button" value="Browse Server" onclick="BrowseServer( 'Images:/', 'xImagePath1' );" />
								<input type="checkbox" name="checkbox1" class="checkbox-answer-img" 
								<?php if(isset($storage_answer[1]['correct_answer']) && $storage_answer[1]['correct_answer'] == 1) echo 'checked="checked"'; ?>
								value="1" /> 
								<?php if(isset($storage_answer[1]['answer'])) :?>
								<div>
									<img class="thumb" src="<?php echo $storage_answer[1]['answer']; ?>" width="100" />
								</div>
								<?php endif; ?>
							</p> 
							<p>
							c.  <input id="xImagePath2" class="text-input medium-input" name="ImagePath[]" type="text" size="60" 	
								value="<?php if(isset($storage_answer[2]['answer'])) echo $storage_answer[2]['answer']; ?>" />
								<input class="button" type="button" value="Browse Server" onclick="BrowseServer( 'Images:/', 'xImagePath2' );" />
								<input type="checkbox" name="checkbox1" class="checkbox-answer-img" 
								<?php if(isset($storage_answer[2]['correct_answer']) && $storage_answer[2]['correct_answer'] == 1) echo 'checked="checked"'; ?>
								value="2" /> 
								<?php if(isset($storage_answer[2]['answer'])) :?>
								<div>
									<img class="thumb" src="<?php echo $storage_answer[2]['answer']; ?>" width="100" />
								</div>
								<?php endif; ?>
							</p> 
							<p>
							d. 	<input id="xImagePath3" class="text-input medium-input" name="ImagePath[]" type="text" size="60" 
								value="<?php if(isset($storage_answer[3]['answer'])) echo $storage_answer[3]['answer']; ?>" />
								<input class="button" type="button" value="Browse Server" onclick="BrowseServer( 'Images:/', 'xImagePath3' );" />
								<input type="checkbox" name="checkbox1" class="checkbox-answer-img" 
								<?php if(isset($storage_answer[3]['correct_answer']) && $storage_answer[3]['correct_answer'] == 1) echo 'checked="checked"'; ?>
								value="3" /> 
								<?php if(isset($storage_answer[3]['answer'])) :?>
								<div>
									<img class="thumb" src="<?php echo $storage_answer[3]['answer']; ?>" width="100" />
								</div>
								<?php endif; ?>
							</p>  
						</span>
