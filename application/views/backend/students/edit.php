					...
					<fieldset>
						...
						<p>
							...
							<input
								...
								name="indentity_number" id="indentity_number" value="<?php echo @$student['indentity_number']; ?>" />
						</p>  				
						<p>
							<label>Tên học sinh</label> 
							<input
								class="text-input medium-input " type="text" 
								name="fullname" id="fullname" value="<?php echo @$student['fullname']; ?>" />
						</p>  
						<p>
							<label>Tên đăng nhập</label> 
							<input
								class="text-input medium-input username" type="text" 
								name="username" id="username" value="<?php echo @$student['username']; ?>" />
						</p>  
						<p>
