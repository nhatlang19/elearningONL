		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">								
				...
				<?php
					...
					echo anchor(BACK_END_TMPL_PATH . 'students/edit', $new_page, array('class' => 'shortcut-button')); 
				?>
				</li>
				<li>
				<?php
					...
					echo anchor(BACK_END_TMPL_PATH . 'students/import', $new_page, array('class' => 'shortcut-button')); 
				?>
				</li>
									...
									<td colspan="3">
										<div class="bulk-actions align-left">
											<input
												...
												name="name" id="name" placeholder="Họ tên" value="<?php echo $name; ?>" />
										</div>
										<div class="clear"></div>
									</td>
									<td >
										<div class="bulk-actions align-right">
											Chọn lớp: <select name="class_id" onchange="adminForm.submit();">
												...
												?>
													<option <?php echo $selected; ?> value="<?php echo $class['class_id']; ?>"><?php echo $class['class_name']; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="clear"></div>
