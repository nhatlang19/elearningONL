	...
	<div class="content-box">
		...
		<div class="content-box-content">
			...
			<div class="tab-content" id="tab1">
				...
				<?php echo form_open_multipart(BACK_END_TMPL_PATH . 'academic/edit'); ?>
					...
					<fieldset>
						...
						<p>
							...
							<input
								...
								name="academic_name" id="academic_name" value="<?php echo @$academic['academic_name']; ?>" />
						</p>  
...
<script src="<?php echo BACK_END_JS_PATH; ?>academic/edit.js"></script>		