		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">								
				...
				<?php
					...
					echo anchor(BACK_END_TMPL_PATH . 'subject/edit', $new_page, array('class' => 'shortcut-button')); 
				?>
				</li>
						...
						<table>
							...
							<tbody id="">
								...
								<tr>
									<td><?php echo $i++; ?></td>
									<td>
									<input type="checkbox" name="check[]" id="check" value="<?php echo $value['subjects_id']; ?>" />
									</td>
