	...
	<div class="content-box">
		...
		<div class="content-box-content">
			...
			<div class="tab-content" id="tab1">
				...
				<?php echo form_open_multipart(BACK_END_TMPL_PATH . 'storage/edit'); ?>
					...
					<fieldset>
						...
						<p>
							...
							<select name="subjects_id" id="subjects_id"
								class="medium-input">
								...
								?>
								<option <?php echo $selected; ?> value="<?php echo $item['subjects_id']; ?>"><?php echo $item['subjects_name']; ?></option>
								<?php endforeach; ?>
							</select>
						</p>  
						<?php endif; ?>
		...
		<!-- </div>  End .content-box -->
<script src="<?php echo BACK_END_JS_PATH; ?>storage/edit.js"></script>