		<div id="main-content"> <!-- Main Content Section with everything -->
			<?php echo form_open(BACK_END_TMPL_PATH . 'exam/lists', array('name' => "adminForm", 'id' => 'adminForm')); ?>	
			<!-- Page Head -->
			...
			<ul class="shortcut-buttons-set">								
				...
				<?php
					...
					echo anchor(BACK_END_TMPL_PATH . 'exam/edit', $new_page, array('class' => 'shortcut-button')); 
				?>
				</li>
						...
						<table>
							...
							<tbody id="">
								...
								<tr>
									<td><?php echo $i++; ?></td>
									<td>
									<input type="checkbox" name="check[]" id="check" value="<?php echo $value['exam_id']; ?>" />
									</td>
									<td><?php echo anchor(BACK_END_TMPL_PATH . 'exam/edit/' . $value['exam_id'], $value['title']); ?></td>
